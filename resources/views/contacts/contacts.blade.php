<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="/clients/create" class="bg-violet-600 hover:bg-violet-100 text-white hover:border-violet-600 border
            ...
            @foreach($clients as $client)
                ...
                <div class="p-6 text-gray-900">
                        @if(auth()->user()->can('Возможность удалять клиентов'))
                    <a href="/clients/delete/{{$client->id}}" class="bg-red-600 hover:bg-red-100 text-white hover:border-red-600 border
                                hover:text-red-600 px-4 py-2 rounded">
                        Удалить
                    </a>
                        @endif
                        @if(auth()->user()->can('Возможность редактировать клиентов'))
                    <a href="/clients/edit/{{$client->id}}" class="bg-teal-700 text-white border-teal-700 hover:border-teal-900
