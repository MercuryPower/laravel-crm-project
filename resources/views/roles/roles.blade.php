<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="/roles/create" class="bg-violet-600 hover:bg-violet-100 text-white hover:border-violet-600 border
            ...
            @foreach($roles as $role)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg my-3 grid md:grid-cols-4 grid-cols-1">
                    ...
                    <div class="p-6 text-gray-900">
                        <a href="roles/delete/{{$role->id}}"
                           class="bg-red-600 hover:bg-red-100 text-white hover:border-red-600 border
                                hover:text-red-600 px-4 py-2 rounded">
                            Удалить
                        </a>
                        <a href="roles/edit/{{$role->id}}" class="bg-teal-700 text-white border-teal-700 hover:border-teal-900
